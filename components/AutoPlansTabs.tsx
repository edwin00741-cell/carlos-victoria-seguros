...
const categories: PlanCategory[] = [
  {
    ...
    plans: [
      ...
      },
      {
        ...
        payment: "Pago al contado o en 2 letras de B/.79.13.",
      },
      {
        insurer: "Seguros FEDPA",
        logo: "/insurers/fedpa.svg",
        ...
        payment: "Pago al contado o en 2 letras de B/.100.44",
      },
      {
        ...
        payment: "Pago al contado o en 3 letras de B/.61.00 por tarjeta de crédito o débito.",
        featured: true,
      },
    ],
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        benefits: ["Hasta 3 eventos de grúa", "Asistencia vial y ambulancia", "Asistencia legal"],
        payment: "Pago por tarjeta de crédito, hasta máximo 2 letras mensuales de B/.92.50. Pago por Yappy o voluntario B/.200.00",
      },
      {
        ...
        payment: "Pago al contado o 3 letras mensuales B/.67.04 por tarjeta de crédito o débito.",
      },
    ],
  },
  {
    ...
    plans: [
      {
        ...
        benefits: ["Hasta 3 eventos de grúa", "Asistencia vial y ambulancia", "Asistencia legal"],
        payment: "Pago al contado o en 3 letras de B/.69.33 por tarjeta de crédito o débito.",
        featured: true,
      },
      {
        insurer: "ASSA Compañía de Seguros",
        ...
        benefits: ["Hasta 3 eventos de grúa", "Asistencia vial y ambulancia", "Asistencia legal"],
        payment: "Pago al contado o 2 letras mensuales B/.105.93 por tarjeta de crédito o débito.",
      },
      {
        insurer: "Acerta Seguros",
        logo: "/insurers/acerta.png",
  ...
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        coverage: ["Lesiones corporales B/.50,000 / B/.100,000", "Daños a la propiedad ajena B/.50,000", "Gastos médicos B/.5,000 / B/.25,000"],
        benefits: ["Hasta 3 eventos de grúa", "Asistencia vial y ambulancia", "Asistencia legal"],
        payment: "Pago al contado o en 3 letras de B/.84.09 por tarjeta de crédito o débito",
        featured: true,
      },
    ],
  },
    ...
    plans: [
      {
        ...
        payment: "Pago en letras: B/.339.08. I pago: B/.131.23. II pago: B/.103.93. III pago: B/.103.93.",
      },
      {
        insurer: "Seguros FEDPA",
        logo: "/insurers/fedpa.svg",
        ...
        payment: "Pago en letras: B/.369.08. I pago: B/.141.23. II pago: B/.113.93. III pago: B/.113.93.",
      },
      {
        insurer: "Seguros FEDPA",
        logo: "/insurers/fedpa.svg",
        ...
        payment: "Pago en letras: B/.389.08. I pago: B/.147.89. II pago: B/.120.60. III pago: B/.120.60.",
        featured: true,
      },
    ],
  },
