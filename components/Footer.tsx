  ...
  return (
    <footer className="site-footer">
      <div className="section-shell footer-main">
        <div className="footer-brand"><BrandMark light /><p>Asesoría personalizada para ayudarte a comprender y evaluar tus opciones de protección.</p><span>Licencia profesional PN8794</span><div className="footer-regulator"><img src="/brand/ssrp-logo.png" alt="Superintendencia de Seguros y Reaseguros de Panamá" /><span>Regulado y supervisado por la Superintendencia de Seguros y Reaseguros de Panamá</span></div></div>
      ...
      <div className="section-shell legal-note"><p>Las coberturas, primas y condiciones finales dependen de evaluación y emisión por parte de la aseguradora correspondiente.</p><div className="legal-credit"><span>© {new Date().getFullYear()} Carlos Victoria. Todos los derechos reservados.</span><a href="https://www.harmonyagency.lat" target="_blank" rel="noreferrer">Creado por Harmony Agency</a></div></div>
    </footer>
  );
}
